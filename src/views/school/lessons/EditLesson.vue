    ...
    <div class="create-lesson u-container u-mr-auto u-ml-auto u-mt-17">
      <div class="u-row">
        ...
        <div class="u-col-6 input-block-create">
          ...
          <CsvUpload class="u-mb-7" accept=".csv" v-model="file"> </CsvUpload>
        </div>
...
export default {
  ...
  methods: {
    ...
    addTableRows() {
      ...
      const rowOrder =
        tableRowsLength > 0 ? this.tableRows[tableRowsLength - 1].order + 1 : 1;
    ...
    updateImages(rowOrder, images) {
      ...
      images.forEach((file) => {
        this.tableRows[index].images.values.push({
          id: "",
          delete: false,
          image: file,
          default: false,
    ...
    updateLesson() {
      ...
      this.sendLesson(
        ...
        .then(() => {
          // this.$router.push({ name: 'school-lessons-all' });
          this.fetchLesson({
            id: this.$route.params.id,
          }).then((res) => {
            this.name = res.data.title;
