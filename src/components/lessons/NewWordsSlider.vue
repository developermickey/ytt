    ...
    <UCard class="new-words-slider" v-if="words.length" :key="isFliped">
      ...
      >
        <div class="new-words-slider__item" ref="wordsSliderList">
          <div class="new-words-slider__slide">
            <div class="new-words-slider__slide-row">
              ...
              >
                <img
                  :class="{
                    'new-words-slider__image_hidden': hideLessonImages,
                  }"
                  :src="currentSlide.image_default"
                  alt=""
                  @error="replaceByDefault"
                />
                <ul class="new-words-slider__images-list" v-show="showImgList">
                  <li
                  ...
                  >
                    <img
                      :class="{
                        'new-words-slider__images-list-item_default':
                          img.default,
                      }"
                      :src="img.image"
                      alt=""
              ...
              <div class="new-words-slider__hebrew">
                {{ currentSlide.word }}
              </div>
            </div>
            <div
            ...
            >
              ...
              >
                <li
                  ...
                  :class="{
                    'new-words-slider__transation-list-item_default':
                      translation.default,
                  }"
          ...
          <div class="new-words-slider__slide-row">
            <img
              class="new-words-slider__logo"
              src="@/assets/logo.svg"
              alt=""
            />
            <div class="new-words-slider__page-number">
              ({{ currentSlide.serial }})
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    ...
    this.$refs.wordsSliderList.addEventListener(
      'mousedown',
  ...
  beforeDestroy() {
    ...
    this.$refs.wordsSliderList.removeEventListener(
      'mousedown',
      this.handleSwipeStart
    );
    this.$refs.wordsSliderList.removeEventListener(
  ...
  computed: {
    ...
    progressBarStyle() {
      if (this.hideLessonTranslations) {
        ...
        return {
          width:
            (Math.floor((this.currentIndex + 1) / 2) /
              (this.computedSlides.length / 2)) *
              100 +
            '%',
        };
  ...
  methods: {
    ...
    ...mapActions('Words', ['setDefaultImageOfSlider']),
    ...
    onProgressBarMousemove(event) {
      const bounds = document
        .getElementById('slider-progress')
    ...
    async setDefaultImg(id) {
      ...
      let payload = {
        ...
        wordId: this.currentSlide?.id,
        imageUrl: img?.image,
      };
      await this.setDefaultImageOfSlider(payload);
      await this.fetchStudentsLesson({
        studentId: this.$route.params.studentId,
        lessonId: this.$route.params.id,
      });
    },
    setDefaultTranslation(id) {
      const translation = this.currentSlide.all_translations.find(
